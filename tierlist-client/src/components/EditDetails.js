                    ...
                    <DialogContent>
                        <form>
                            <TextField name="userName" type="text" label="Username" 
                                ...
                                value={this.state.userName} onChange={this.handleChange} fullWidth></TextField>
